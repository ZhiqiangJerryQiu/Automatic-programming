...
public class DevysSynonymFilterTest {
	StringReader content = new StringReader("≥Î∆Æ∫œ");

	List<String> synonymWordList = new ArrayList<String>();

	@Before
	public void setUp() throws Exception {
		synonymWordList.add("≥Î∆Æ∫œ");
		synonymWordList.add("≥Î∆Æ∫œpc");
		synonymWordList.add("≥Î∆Æ∫œƒƒ«ª≈Õ");
		synonymWordList.add("≥Î∆Æ∫œ««ææ");
